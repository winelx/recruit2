...
import com.recruit.zejuxin.recruit.Code.util.drop.entity.FilterType;
...
/**
 * Created by 10942 on 2017/9/27 0027.
 */
...
public class DropMenuAdapter implements MenuAdapter {
    ...
    private View createDoubleListView() {
        ...
        comTypeDoubleListView.getLeftListView().
                setBackgroundColor(
                        mContext.
                                getResources()
                                .getColor(R.color.b_c_fafafa)
                );
